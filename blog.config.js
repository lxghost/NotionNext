...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'bad334a4279b4afc8f3ef766e3851f0e',
  ...
  AUTHOR: 'lxghost', // 您的昵称 例如 tangly1024
  BIO: '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lxghost.com', // 网站地址
  KEYWORDS: 'welcome to hell', // 网站关键词 英文逗号隔开
